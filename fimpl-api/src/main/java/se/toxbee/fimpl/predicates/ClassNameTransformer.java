...
/**
 * ClassNameTransformer is a PredicateInputTransformer for class names.
 *
 ...
 * @since Jan, 24, 2014
 */
public class ClassNameTransformer<I> implements PredicateInputTransformer<I, String> {
	@Override
	public String transformForPredicate( ImplementationInformation info, ImplementationResultSet<I, ?> set ) {
		return info.getImplementorClass();
	}
}
